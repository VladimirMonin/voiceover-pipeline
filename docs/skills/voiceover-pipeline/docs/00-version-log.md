...
| 2026-08-24 | OmniVoice Russian design теперь fail-closed отклоняет English accent/Chinese dialect conditioning; добавлены path-free execution provenance и transcript-free `verify-tts` gate для omissions/insertions/repetitions. Technical PASS не заменяет human listening. |
